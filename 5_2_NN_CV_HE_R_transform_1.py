...
file_output = '/Volumes/Transcend/GitHub/Statistical Machine Learning/Assignment_1/result_NN_CV_HE_R_transform_1.csv'
...
parameter_space = {
    'hidden_layer_sizes': [(randint.rvs(1,30,1), randint.rvs(1,30,1),randint.rvs(1,20,1),), (randint.rvs(1,30,1), randint.rvs(1,20,1),), (randint.rvs(1,20,1),)],
    'alpha': uniform(0.0001, 0.9),
    'learning_rate': ['constant','adaptive']}

nn = MLPClassifier(max_iter = 2000, activation = 'relu')
